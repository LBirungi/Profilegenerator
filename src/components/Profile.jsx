    ...
    <div className="min-h-screen bg-gray-100 py-10">
      <div className="w-full bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="flex flex-col items-center -mt-16 md:-mt-24">
          <img src="" alt="ProfileImage" className="h-24 w-24 md:h-36 md:w-36 rounded-full border-4 border-white bg-gray-200 object-cover" />
          <h1 className="text-xl md:text-2xl font-semibold text-gray-800 mt-2">Lillian Birungi</h1>
              ...
              {[...Array(6)].map((_, index) => (
                <div key={index} className="bg-gray-100 p-4 rounded-lg shadow">
                  ...
                  <div className="flex mt-2">
                    <span className="bg-blue-200 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">Language</span>
